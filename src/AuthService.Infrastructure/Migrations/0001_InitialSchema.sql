...
INSERT INTO roles (id, tenant_id, name, normalized_name, description, is_system_role) VALUES
    (uuidv7(), NULL, 'SuperAdmin', 'SUPERADMIN', 'Full system access',      TRUE),
    (uuidv7(), NULL, 'Admin',      'ADMIN',      'Administrative access',   TRUE),
    (uuidv7(), NULL, 'User',       'USER',       'Standard user access',    TRUE),
    (uuidv7(), NULL, 'TenantAdmin','TENANTADMIN','Manage a single tenant',  TRUE);

-- Platform permissions
INSERT INTO permissions (id, tenant_id, name, description, resource, action) VALUES
    (uuidv7(), NULL, 'user:read',        'View user profiles',            'user',       'read'),
    (uuidv7(), NULL, 'user:write',       'Create and update users',       'user',       'write'),
    (uuidv7(), NULL, 'user:delete',      'Delete user accounts',          'user',       'delete'),
    (uuidv7(), NULL, 'role:read',        'View roles',                    'role',       'read'),
    (uuidv7(), NULL, 'role:write',       'Create and update roles',       'role',       'write'),
    (uuidv7(), NULL, 'role:assign',      'Assign roles to users',         'role',       'assign'),
    (uuidv7(), NULL, 'permission:read',  'View permissions',              'permission', 'read'),
    (uuidv7(), NULL, 'permission:write', 'Create and update permissions', 'permission', 'write'),
    (uuidv7(), NULL, 'client:read',      'View OAuth clients',            'client',     'read'),
    (uuidv7(), NULL, 'client:write',     'Manage OAuth clients',          'client',     'write'),
    (uuidv7(), NULL, 'audit:read',       'View audit logs',               'audit',      'read'),
    (uuidv7(), NULL, 'tenant:read',      'View tenants',                  'tenant',     'read'),   -- NEW
    (uuidv7(), NULL, 'tenant:write',     'Create and update tenants',     'tenant',     'write'),  -- NEW
    (uuidv7(), NULL, 'tenant:delete',    'Delete tenants',                'tenant',     'delete'); -- NEW